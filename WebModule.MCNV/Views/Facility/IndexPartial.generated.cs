...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Facility/IndexPartial.cshtml")]
    public partial class _Views_Facility_IndexPartial_cshtml : WebApp.Core.BaseWebViewPage<Facility.ListInfo>
    {
        public _Views_Facility_IndexPartial_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\Facility\IndexPartial.cshtml"
Write(Html.DevExpress().GridView(st =>
{
   ...
   st.Columns.Add(col =>
   {
      col.FieldName = "FacilityType.Name";
      col.Caption = T("Loại hình đơn vị");
   });
   st.Columns.Add(col =>
   {
